...
const Home = () => {
    return (
        <>
            ...
            <Container fluid className='bg-dark my-0 py-4'>
                <Container>
                    <h1>Home</h1>
            ...
            <footer className="bg-secondary py-4 container-fluid">
                <div className="container">
                    <div className="row">
                        <div className="col-6"><h5>Navigation</h5></div>
                    </div>
                    <div className="row">
                        <div className="col-6">
                            <div className="row">
                                <ul className="col nav flex-column">
                                    <li className="nav-item"><a
                                        href="/admin/site/preview/default/draft/lyn-konner/chimaera"
                                        className="py-1 nav-link"><h5 className="fs-6">Chimära</h5></a></li>
                                    <li className="nav-item"><a
                                        href="/admin/site/preview/default/draft/lyn-konner/chimaera/galerie-der-toten"
                                        className="py-1 nav-link">Galerie der Toten</a></li>
                                    <li className="nav-item"><a
                                        href="/admin/site/preview/default/draft/lyn-konner/chimaera/der-blutdiamant"
                                        className="py-1 nav-link">Der Blutdiamant</a></li>
                                </ul>
                                <ul className="col nav flex-column">
                                    <li className="nav-item"><a
                                        href="/admin/site/preview/default/draft/lyn-konner/secretum2"
                                        className="py-1 nav-link"><h5 className="fs-6">Secretum</h5></a></li>
                                    <li className="nav-item"><a
                                        href="/admin/site/preview/default/draft/lyn-konner/secretum2/requiem"
                                        className="py-1 nav-link">Requiem</a></li>
                                    <li className="nav-item"><a
                                        href="/admin/site/preview/default/draft/lyn-konner/secretum2/reliquie"
                                        className="py-1 nav-link">Reliquie</a></li>
                                </ul>
                                )}
                            </div>
                        </div>
                        <div className="text-end col"><h5>other stuff</h5></div>
                    </div>
                </div>
            </footer>
        </>

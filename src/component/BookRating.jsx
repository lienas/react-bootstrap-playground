...
export const BookRating = ({color, size}) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width={size * 0.5 + 'em'} height={size * 0.5 + 'em'}
             fill={color} className='me-1'>
            <path
                d="M1.6,11.5l0-7.2H0.9v9.1c1.1-0.3,2.2-0.5,3.3-0.5c1,0,2.1,0.1,3.1,0.5c-0.6-0.5-1.4-0.9-2.1-1.2c-1-0.3-2-0.4-3.1-0.3
